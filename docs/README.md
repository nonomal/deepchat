...
| 文档                                                                        | 用途                                                                                |
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [Module performance audit](./architecture/module-performance-audit/spec.md) | Module coverage, confirmed repairs, test evidence, and remaining measurement limits |
...
| 文档                                                                                                           | 状态                                                                                           |
| -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| [features/acp-v1-reliability/](./features/acp-v1-reliability/)                                                 | Implemented capability, auth, session lifecycle, and diagnostics; acceptance follow-ups remain |
