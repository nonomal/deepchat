    ...
    public static let handler = ToolHandler(
        tool: Tool(
            ...
            description: """
                ...
                For free-form text entry into web inputs, prefer `type_text`
                with `delay_ms`; it falls back to synthesized key events when
                AX text writes are ignored by WebKit or Chromium.
                """,
            inputSchema: [
                "type": "object",
